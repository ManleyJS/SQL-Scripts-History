...
CREATE ROLE warner_rotaready_dataload;

create user warner_rotaready_dataload
password = '<REDACTED>' 
login_name = 'warner.rotaready.dataload'
display_name = 'Warner Rota Ready Data Load'
default_role = warner_rotaready_dataload
default_warehouse = bourne_batch_dataload_xsmall
default_namespace = warner_raw.rotaready;

USE ROLE securityadmin;
GRANT ROLE _warner_raw__rotaready__creator TO ROLE warner_rotaready_dataload;
GRANT ROLE _bourne_batch_dataload__warehouse__usage TO ROLE warner_rotaready_dataload;
GRANT ROLE warner_rotaready_dataload TO USER warner_rotaready_dataload;
