...
drop table pklogwork.salesorderdetail_base cascade;
...
create table pklogwork.salesorderdetail_base as select * from dblink('user=postgres password=Public24082021 dbname=advwrksdw host=cdctestinstance.cluster-cgg8jq7kqbjx.eu-west-1.rds.amazonaws.com', 
...
insert into salesorderdetail select * from salesorderdetail_base ;
...
alter table pklogwork.salesorderdetail add primary key (pk_id);
...
alter table if exists pklogwork.salesorderdetail replica identity full;
